...
//        Assert.assertEquals("Returned invalid country object", json.get("currency").asString(), "EUR");
        Assert.assertEquals("Returned invalid country object", json.get("name").asString(), "jit");
        Assert.assertEquals("Returned invalid country object", json.get("balance").asString(), "karan");
        Assert.assertEquals("Returned invalid country object", json.get("id").asString(), "roy");
    }
}
